<template>
  <div class="create-company-form">
    <h1 class="h1 create-company-form-title">Je choisis le <span>type de société</span> que je veux créer</h1>
    <p class="create-company-form-subtitle">Plutôt que de passer des heures à remplir des documents CERFA, laissez-nous
      le faire pour vous en nous fournissant quelques informations !</p>
    <div class="create-company-form-buttons">
      <router-link :to="{name: 'home'}" class="button button-small button-with-icon button-primary">
        EURL
